...
import (
	...
	netmetrics "github.com/blockchain/go-blockchain/metrics"
...
func Setup(ctx *cli.Context) {
	if netmetrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(netmetrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
