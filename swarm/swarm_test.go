...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/net.ipc",
			endpoint:    "/data/testnet/net.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/net.ipc",
			endpoint:    "/data/testnet/net.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/net.ipc",
			endpoint:    "/data/testnet/net.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/net.ipc",
			endpoint:    "/data/testnet/net.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
