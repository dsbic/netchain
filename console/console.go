...
// Welcome show summary of current Net instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Net metadata
	fmt.Fprintf(c.printer, "Welcome to the Net JavaScript console!\n\n")
	c.jsre.Run(`
