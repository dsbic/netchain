...
func DefaultDataDir() string {
	...
	if home != "" {
		if runtime.GOOS == "darwin" {
			return filepath.Join(home , /*"Library", "Blockchain"*/ "netdata")
		} else if runtime.GOOS == "windows" {
			return filepath.Join(home , /*"AppData", "Roaming", "Blockchain"*/ "netdata")
		} else {
			return filepath.Join(home, /*".blockchain"*/ "netdata")
		}
	}
