...
// NodeConfig represents the collection of configuration values to fine tune the Net
...
// Node represents a Net Blockchain node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Net node.
