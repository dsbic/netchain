...
// issuing, receiving, verifying cheques in neter; (auto)cashing cheques in neter
// as well as (auto)depositing neter to the chequebook contract.
package chequebook
...
// * depositing neter to the chequebook
// * watching incoming neter
