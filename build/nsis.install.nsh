...
Section "Geth" GNET_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:44444)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:44444)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:44444)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:44444)" ""  6 1 1 2147483647 1 "$INSTDIR\net.exe" "" "" "Blockchain" 44444 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:44444)" ""  6 2 1 2147483647 1 "$INSTDIR\net.exe" "" "" "Blockchain" "" 44444 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:44444)" "" 17 2 1 2147483647 1 "$INSTDIR\net.exe" "" "" "Blockchain" "" 44444 "" ""
